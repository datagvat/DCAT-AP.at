...
(function() {
  ...
  var collapseSidebarText = '<span aria-hidden="true">←</span> '
                          + '<span>Dölj innehållsförteckningen</span>';
  var expandSidebarText   = '<span aria-hidden="true">→</span> '
                          + '<span>Visa innehållsförteckningen</span>';
  var tocJumpText         = '<span aria-hidden="true">↑</span> '
                          + '<span>Gå till innehållsförteckningen</span>';
  ...
  var tables = document.querySelectorAll(':not(.overlarge):not(.no-overlarge) > table.data, :not(.overlarge) >' +
    ' table.index');
